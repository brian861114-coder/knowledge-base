...
def normalize_and_merge_sections(sections: list[SectionBlock], rename_map: dict[str, str], merge_targets: set[str]) -> tuple[list[SectionBlock], list[str]]:
    ...
    for section in sections:
        ...
        normalized[existing_index] = SectionBlock(heading=existing.heading, body=joined, source_heading=existing.source_heading)
