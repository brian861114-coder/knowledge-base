...
def build_frontmatter(*, title: str, note_type: str, summary: str, domain: str | None) -> str:
    lines = [
        "---",
        f'title: "{title}"',
        f"type: {note_type}",
...
def main() -> None:
    ...
    parser.add_argument("--type", required=True, help="Note type id, e.g. concept/law/quantity/experiment/map/mathematical_tool")
    ...
    parser.add_argument("--domain", help="Required for law/concept/quantity/experiment")
    ...
    if note_type in DOMAIN_REQUIRED_TYPES and not args.domain:
